...
public class Canasta extends javax.swing.JFrame {
    ...
    private static Canasta objVistaCrear;
    ...
    public Canasta(Controlador objControlador) {
        initComponents();
        fecha();
        ...
        tablaCanasta.setDefaultRenderer(Object.class, renderer);
        tablaCanasta.setBackground(Color.white);
        asignarTitulo();   
    ...
    public static Canasta obtenerCanasta(Controlador objControlador) {
        
        if (objVistaCrear == null) {
            
            objVistaCrear = new Canasta(objControlador);            
        }
    ...
    private void initComponents() {
        ...
        btnCalcular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Iconos/accounting_32.png"))); // NOI18N
        ...
        label_Nit_CC.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelNumFactura.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelIVA.setBackground(new java.awt.Color(255, 255, 255));

        labelTotalAPagar.setBackground(new java.awt.Color(255, 255, 255));

        btnGuardarFactura.setBackground(new java.awt.Color(255, 255, 255));
        btnGuardarFactura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Iconos/floppy-disk_32.png"))); // NOI18N
        ...
        btnSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Iconos/error32.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(21, 21, 21)
                        .addComponent(btnGuardarFactura, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        calculado = objControlador.operaDatosTablaVentas( tablaCanasta, labelIVA, labelTotalAPagar);
        if(calculado == true){
    ...
    private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirActionPerformed
        ...
        if (guardado == true) {
            ...
            int reply = JOptionPane.showConfirmDialog(null, "Desea Salir sin Guardar", "No ha guardado la Factura", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    public void datosNuevaFactura() {
        ...
        ArrayList<ClientesVO>  arreglo = objControlador.getDatosClienteCanasta();
        //Se trae el id del /*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
...
public class Canasta extends javax.swing.JFrame {
    ...
    public String asignarTitulo() {
        return (objControlador.empleadoSesionAbierta());
